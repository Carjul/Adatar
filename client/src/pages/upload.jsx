...
const Upload = () => {
 ...
 if(swich && message){
  ...
  useEffect(() => {
    ...
    const propiedades = Object.getOwnPropertyNames(message);
    propiedades.length === 0? document.getElementById('datos').innerHTML = message:null
  }, [message,dispatch])
        ...
        <div className='flex flex-col items-center w-full h-full'>
          ...
          {swich ?
            ...
            <div>
              ...
              <div className="flex-1 card w-auto bg-base-100 shadow-xl">
